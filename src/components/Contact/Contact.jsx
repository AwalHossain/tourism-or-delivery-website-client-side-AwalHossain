...
const Contact = () => {
    ...
    <div>
         <div className="pt-6 px-4">
            <h2 className="text-4xl font-semibold pb-5">Contact with us Anytime</h2>
         </div>
        <form class="w-full max-w-lg">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Mary" />
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-6">
